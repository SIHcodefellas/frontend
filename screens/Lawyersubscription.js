...
const Lawyersubscription = () => {
    ...
    const subscriptionData = [
        { price: 'Rs. 0', features: ['Easy access to our wide range of database', 'Chatbot to help you understand laws deeply', 'Gain detailed knowledge on your cases'], style: styles.carouselItemBlue, buttonLabel: 'Go to Homepage', destination: 'LawyerHomepage' },
        { price: 'Rs. 200', features: ['Easy access to our wide range of database', 'Chatbot to help you understand laws deeply', 'Gain detailed knowledge on your cases', 'A wide range of paid clients'], style: styles.carouselItemYellow, buttonLabel: 'Subscribe Now', link: 'https://paytm.com/' },
    ];
    ...
    return (
        <View style={styles.container}>
            <View>
                ...
                <Text style={styles.headertext}>Subscribe to get acess to our premium features</Text>
            </View>
                ...
                <View style={styles.navIconsContainer}>
                    ...
                    <TouchableOpacity>
                        <View style={styles.navIconWrapper}>
                            ...
                            <Ionicons name="card-outline" size={25} color="#1A3567" style={styles.diamondIcon} />
