            ...
            <View>
                ...
                <LineChart
                    ...
                    formatYLabel={(value) => {
                        ...
                        return `${lowerLimit} - ${upperLimit} - ${yAxisLabels[roundedValue - 1]}`;
                    }}
                    chartConfig={{
    ...
    return (
        <View style={styles.container}>
            <View style={styles.topBar}>
                <Ionicons name="menu-outline" size={30} color="black" style={[styles.icon, { marginTop: 0 }]} />
                <Ionicons name="notifications-outline" size={30} color="black" style={[styles.icon, { marginTop: 0 }]} />
            </View>

            {/* Header */}
            <View style={styles.headerContainer}>
                <Text style={styles.headerText}>Hi, Riya! How are you feeling today?</Text>
            </View>

            {/* Emojis */}
            <View style={styles.emojiContainer}>
                <TouchableOpacity><Text style={[{ fontSize: 25 }]}>😥</Text></TouchableOpacity>
                <TouchableOpacity><Text style={[{ fontSize: 25 }]}>🙁</Text></TouchableOpacity>
                <TouchableOpacity><Text style={[{ fontSize: 25 }]}>😐</Text></TouchableOpacity>
                <TouchableOpacity><Text style={[{ fontSize: 25 }]}>🙂</Text></TouchableOpacity>
                <TouchableOpacity><Text style={[{ fontSize: 25 }]}>😇</Text></TouchableOpacity>
            ...
            <ScrollView style={styles.scrollView}>
                <View style={styles.scrollViewcontainer}>
                    ...
                    <View>
                        <Text style={styles.smallheaders}>Feel like journaling your thoughts? 📝</Text>
                        <TouchableOpacity
                    ...
                    <View>
                        <Text style={styles.smallheaders}>Seek Professional Help! Connect</Text>
                        <Text style={styles.withcouncellors}>with Councellors</Text>
                        <TouchableOpacity style={styles.professionalHelpButton}>
                            <Ionicons name="call-outline" size={25} color="#1A3567" style={styles.helpIcon} />
                        </TouchableOpacity>
                    </View>
                    <HorizontalLine />
                    <View>
            ...
            <View style={styles.navigationBar}>
                ...
                <View style={styles.navIconsContainer}>
                    <TouchableOpacity><Ionicons name="home" size={25} color="#1A3567" style={styles.navIcon} /></TouchableOpacity>
                    ...
                    <TouchableOpacity><View style={styles.navIconWrapper}>
                        ...
                        <Ionicons name="heart" size={25} color="#1A3567" style={styles.navIcon} />
